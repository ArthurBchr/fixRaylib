...
int main(void)
{
    ...
    rayRectangle fudesumiRec = {0, 0, fudesumiImage.width, fudesumiImage.height};

    rayRectangle fudesumiPos = {50, 10, fudesumiImage.width * 0.8f, fudesumiImage.height * 0.8f};
    rayRectangle redPos = {410, 10, fudesumiPos.width / 2, fudesumiPos.height / 2 };
    rayRectangle greenPos = {600, 10, fudesumiPos.width / 2, fudesumiPos.height / 2 };
    rayRectangle bluePos = {410, 230, fudesumiPos.width / 2, fudesumiPos.height / 2 };
    rayRectangle alphaPos = {600, 230, fudesumiPos.width / 2, fudesumiPos.height / 2 };
