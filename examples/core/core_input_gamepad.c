        ...
        BeginDrawing();
            ...
            if (IsGamepadAvailable(gamepad))
            {
                ...
                else
                {
                    ...
                    DrawRectangleRounded((rayRectangle){175, 110, 460, 220}, 0.3f, 16, DARKGRAY);
                    ...
                    // Draw buttons: left-right back
                    DrawRectangleRounded((rayRectangle){215, 98, 100, 10}, 0.5f, 16, DARKGRAY);
                    DrawRectangleRounded((rayRectangle){495, 98, 100, 10}, 0.5f, 16, DARKGRAY);
                    if (IsGamepadButtonDown(gamepad, GAMEPAD_BUTTON_LEFT_TRIGGER_1)) DrawRectangleRounded((rayRectangle){215, 98, 100, 10}, 0.5f, 16, RED);
                    if (IsGamepadButtonDown(gamepad, GAMEPAD_BUTTON_RIGHT_TRIGGER_1)) DrawRectangleRounded((rayRectangle){495, 98, 100, 10}, 0.5f, 16, RED);
